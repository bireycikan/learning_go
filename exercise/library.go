...
//* There must only ever be one copy of the l ibrary in memory at anytime
//
//--Notes:
...
func printLibraryAudits(library *Library) {
...
func main() {
	...
	library.members["Birey"] = Member{name: "Birey", books: make(map[Title]LendAudit)}
	library.members["Tom"] = Member{name: "Tom", books: make(map[Title]LendAudit)}
	library.members["Jessica"] = Member{name: "Jessica", books: make(map[Title]LendAudit)}

	fmt.Println("\nInitial:")
	printLibraryBooks(&library)
	printLibraryAudits(&library)

	member := library.members["Birey"]
